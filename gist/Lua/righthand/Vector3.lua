...
function cls:MulQuaternion(q)
    ...
    local x = (((1 - (n5 + n6)) * self.x) + ((n7 - n12) * self.y)) + ((n8 + n11) * self.z)
    local y = (((n7 + n12) * self.x) + ((1 - (n4 + n6)) * self.y)) + ((n9 - n10) * self.z)
    local z = (((n8 - n11) * self.x) + ((n9 + n10) * self.y)) + ((1 - (n4 + n5)) * self.z)
