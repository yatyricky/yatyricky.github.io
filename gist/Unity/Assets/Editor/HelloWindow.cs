...
{
    [MenuItem("Window/UIElements/HelloWindow")]
    public static void ShowExample()
    {
        HelloWindow wnd = GetWindow<HelloWindow>();
    ...
    public void CreateGUI()
    {
        ...
        var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Editor/HelloWindow.uss");
